...
const ConsumerElectronics = () => {
  return (
    <>
      <Container
        className='consumer-electronics-container mt-4 pt-4 pb-4'
        fluid
      >
        <Container className='bg-white'>
          ...
          <Row className='pb-4'>
            <Col className='col-lg-auto col-12'>
              <Card className='consumer-electronics-card'>
                <Card.Img className='' variant='top' src='/img/unnamed_1.png' />
                <Card.Body className='consumer-electronics-main-body'>
                  <Card.Title>
            ...
            <Col className='col-lg-2 '>
              <Card className='consumer-electronics-card'>
                <Card.Img
                  className='consumer-electronics-card-img'
                  variant='top'
                  src='/img/TopCatOfMonth/tcom (3).png'
                />
                <Card.Body>
                  <Card.Title className='consumer-electronics-card-title'>
                    <h6>TV Televisions </h6>
                    <small>302 items</small>
                  </Card.Title>
                </Card.Body>
