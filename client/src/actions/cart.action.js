...
export const addToCart = (product, newQty = 1) => {
  return async (dispatch) => {
    ...
    if (auth.authenticate) {
      ...
      // we save in local storage only when user is not logged in other wise we can fetch 
      // from logged user ka profile ki uske cart me kya then we can put it in local
